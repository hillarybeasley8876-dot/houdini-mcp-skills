...
- [feedback_houdini_city_pcg_layered_with_bbox](../houdini-mcp/references/memory/feedback_houdini_city_pcg_layered_with_bbox.md)
- [reference_pcg_city_template](../houdini-mcp/references/memory/reference_pcg_city_template.md)
- [houdini_procedural_modeling](../houdini-mcp/references/memory/houdini_procedural_modeling.md)
- [houdini_pcg_practitioner_goal](../houdini-mcp/references/memory/houdini_pcg_practitioner_goal.md)
