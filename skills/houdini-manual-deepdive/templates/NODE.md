...
- **它代表的算法 / 数学操作**（受 [houdini_procedural_modeling](../../houdini-mcp/references/memory/houdini_procedural_modeling.md) 启发: 多 ray? KDE? level-set? spatial join?）
...
- **关联 pattern**: 在 [houdini_procedural_modeling](../../houdini-mcp/references/memory/houdini_procedural_modeling.md) 的哪些 pattern 里出现
