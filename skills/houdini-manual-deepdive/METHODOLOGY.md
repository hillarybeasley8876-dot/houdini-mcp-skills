...
### Step 1: Locate
读 `../houdini-manual-deepdive/knowledge/houdini_manual/PROGRESS.md`，找下一个 🟡 或 ⬜ 子主题。规则：
- 严格手册顺序（MANUAL_TOC.md 为准）
- ⏭ 标记的章节直接跳过（动态内容 / 已被其他记忆覆盖）
- **每会话最多 3 个子主题**（[feedback_houdini_corpus_pace](../houdini-mcp/references/memory/feedback_houdini_corpus_pace.md)）
...
- 写法语气向 [houdini-architect-analysis](../houdini-architect-analysis/SKILL.md) 看齐 —— 表格/topology/为什么 > 散文/参数表
...
## Auto-continue 规则（来自 [feedback_houdini_learning_style](../houdini-mcp/references/memory/feedback_houdini_learning_style.md)）
...
- [houdini_procedural_modeling](../houdini-mcp/references/memory/houdini_procedural_modeling.md) 的 36 个 VEX pattern
- [houdini-pcg-practitioner](../houdini-pcg-practitioner/SKILL.md) 的 5-stage pipeline
- [houdini-architect-analysis](../houdini-architect-analysis/SKILL.md) 的 6 个算法 catalog
- [houdini_environment](../houdini-mcp/references/memory/houdini_environment.md) 的安装路径
