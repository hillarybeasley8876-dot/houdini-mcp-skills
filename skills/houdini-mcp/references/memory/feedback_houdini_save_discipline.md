...
Linked: [[houdini-mcp-integration]] for connection setup; [houdini-pcg-practitioner](../../../houdini-pcg-practitioner/SKILL.md) for the build workflow that benefits from this.
