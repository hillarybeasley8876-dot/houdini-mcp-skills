...
**How to apply:** Triggered by any tool result containing "Could not connect to Houdini on localhost:9876" or "Connection Error getting scene info". Skill [[houdini-mcp]] needs updating to lead with this auto-recovery path; meanwhile, do it inline.
